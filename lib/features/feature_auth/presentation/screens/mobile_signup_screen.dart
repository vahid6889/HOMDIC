...
import 'package:homdic/common/params/signup_params.dart';
...
import 'package:homdic/features/feature_auth/data/models/signup_model.dart';
import 'package:homdic/features/feature_auth/presentation/bloc/signup_bloc/signup_bloc.dart';
import 'package:homdic/features/feature_auth/presentation/screens/mobile_login_screen.dart';
...
class _MobileSignUpScreenState extends State<MobileSignUpScreen> {
  ...
  initSmsRetriever() async {
    await AndroidSmsRetriever.listenForSms().then((value) {
      ...
      BlocProvider.of<SignupBloc>(context).add(LoadSignUp(
                        ...
                        BlocConsumer<SignupBloc, SignupState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.callCodeStatus is CallCodeCompleted) {
                              ...
                              showMyBottomSheet(
                                  context, callCodeCompleted.loginWithSmsModel);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BlocConsumer<SignupBloc, SignupState>(
                    buildWhen: (previous, current) {
                      if (previous.signUpDataStatus ==
                          current.signUpDataStatus) {
                        return false;
                      }
                      return true;
                    },
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (codeController.text ==
                              ...
                              BlocProvider.of<SignupBloc>(context).add(
                                  LoadSignUp(SignUpParams(
                                      usernameController.text,
                                      phoneController.text)));
                            } else {
                              Navigator.pop(context);
                              showSnack(context, "کد وارد شده اشتباه است",
                                  Colors.red);
                            }
                          },
                          child: const Text(
