...
import 'package:homdic/config/responsive.dart';
import 'package:homdic/features/feature_home/data/models/home_model.dart';
import 'package:homdic/features/feature_home/presentation/bloc/home_cubit.dart';
import 'package:homdic/features/feature_home/presentation/widgets/deep_links.dart';
                            ...
                            (homeModel.data!.banners!.isNotEmpty)
                                ? GestureDetector(
                                    onTap: () {
                                      ...
                                      if (homeModel
                                              .data!.banners![0].categoryId !=
                                          null) {
                                        Navigator.pushNamed(
                                          context,
                                          AllProductsScreen.routeName,
                                          arguments: ProductsArguments(
                                              categoryId: homeModel.data!
                                                                  ...
                                                                  children: [
                                                                    Column(
                                                                      children: [
                                                                        ...
                                                                        (discountProducts.items![index - 1].priceBeforDiscount !=
                                                                                "0")
                                                                            ? Text(
                                                                                discountProducts.items![index - 1].priceBeforDiscount!,
                                                                                style: const TextStyle(fontFamily: 'Vazir', color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11, decoration: TextDecoration.lineThrough),
                                                                              )
                                                                            : Container(),
                                                                      ],
                                                                    ),
                                                                ...
                                                                children: [
                                                                  Column(
                                                                    children: [
                                                                      ...
                                                                      (organicProducts.items![index].priceBeforDiscount !=
                                                                              "0")
                                                                          ? Text(
                                                                              organicProducts.items![index].priceBeforDiscount!,
                                                                              style: const TextStyle(fontFamily: 'Vazir', color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11, decoration: TextDecoration.lineThrough),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                            scrollDirection: Axis.horizontal,
                                            itemCount:
                                                thirdProductsList.items!.length,
                                            itemBuilder: (context, index) {
                                              return Padding(
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                                ...
                                                                children: [
                                                                  Column(
                                                                    children: [
                                                                      ...
                                                                      (thirdProductsList.items![index].priceBeforDiscount !=
                                                                              "0")
                                                                          ? Text(
                                                                              thirdProductsList.items![index].priceBeforDiscount!,
                                                                              style: const TextStyle(fontFamily: 'Vazir', color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11, decoration: TextDecoration.lineThrough),
